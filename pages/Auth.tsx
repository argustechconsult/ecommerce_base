...
import { Mail, Lock, User as UserIcon, ArrowRight, Github, AlertCircle, ShieldCheck, UserCircle, ShoppingBag } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center py-12 px-4 animate-in zoom-in-95 duration-500">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <h2 className={`text-3xl font-black tracking-tight mb-2 ${role === 'admin' ? 'dark:text-white' : ''}`}>
        ...
        <div className={`transition-all duration-500 p-8 rounded-[2.5rem] shadow-2xl border ${
          role === 'admin' 
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:outline-none transition-colors ${
                    role === 'admin' 
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className={`w-full py-4 rounded-2xl font-black flex items-center justify-center gap-2 transition-all transform active:scale-95 shadow-xl disabled:opacity-50 ${
                role === 'admin' 
            ...
            >
              {isLoading ? (
                <div className={`w-6 h-6 border-4 rounded-full animate-spin ${role === 'admin' ? 'border-slate-200 border-t-slate-900' : 'border-white/30 border-t-white'}`} />
              ) : (
                <>
          ...
          {role === 'customer' && (
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors font-bold text-xs uppercase tracking-wider">
